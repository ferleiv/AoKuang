...
{ //Hilo principal
    ...
    public static boolean busInstrucciones=true; //Los buses inician desocupados
    ...
    public void imprimirEstado(){
        ...
        for(int i = 0; i < 24; i++) //Tiene 24 bloques en total
        {
            ...
            {
                bloque = bloque + memoriaPrincipalDatos[posMemDatos] + " | "; //String de la linea de cada bloque
            }
